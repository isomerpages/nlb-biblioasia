...
<img src="/images/Vol%207%20issue%204/GraphicNovels/blackboard7.jpg" style="width:80%;">
 <div style="background-color: white;"></div>

#### **Limitations**

There were a few limitations to the experiment. Only one class of pupils was available for the experiment. The sample size of 36 pupils fits the class size for most Singaporean classrooms but to generalise with this small group size is an issue. The research had to be conducted within the school’s existing schedule and so a few days after the pre-test, the groups were separated and taught by different teachers — each with two years of teaching experience — in two separate classrooms at the same time. Two pupils from the Control group were absent on the day of the post-test. The survey had to be conducted a few days after the post-test due to schedule constraints. In addition, the results collected for the Treatment group contained one additional response because this pupil did not report that he had been absent during the lesson and posttest, and the anonymous nature of the survey prevented the researchers from identifying and removing his response from the consolidated responses.
