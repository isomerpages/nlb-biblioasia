...
The language in the texts also has links with Java’s linguistic ecology. In the Malay-language texts, a few forms are more readily recognisable as reflections of Javanese words than Malay/Indonesian words, while the language of the Portuguese Creole texts is especially reminiscent of the Batavia and Tugu samples published by Schuchardt and recorded in a few other complementary sources.
