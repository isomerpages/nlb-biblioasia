...
|The traditional units of weight in Malaya were <i>tahil, kati</i> and *pikul*.

16 *tahils* = 1 *kati*<br>
100 *katis* = 1 *pikul*

1 *tahil* = 37.8 grams<br>
1 *kati* = 600 grams (approximate)<br>
1 *pikul* = 60 kilograms (approximate)<br>
