...
The answers to such questions lie in our ability and willingness to internalise the spirit and essence of a text, and not only its outward form. If we just study the text at the surface level, we will be limited in the value that we can derive from it. For example, we would only see <i>Tok Sumang</i> as a work of historical fiction about a personality from the Malay feudal past.
