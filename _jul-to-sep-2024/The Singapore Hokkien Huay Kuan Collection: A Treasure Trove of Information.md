...
This brief survey only touches the surface of what is available in the Singapore Hokkien Huay Kuan Collection. You can request to view the materials highlighted in this article (access information can be found in the Notes listed below), or find out more by consulting us (via email at&nbsp;[ref@nlb.gov.sg](mailto:ref@nlb.gov.sg)&nbsp;or at the reference counter on Level 11 of the Lee Kong Chian Reference Library, National Library Building).
