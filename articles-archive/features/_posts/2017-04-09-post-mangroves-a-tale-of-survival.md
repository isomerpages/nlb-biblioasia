...
<br><br>
Wood from the <i>Rhizophora apiculata</i>, also known as <i>bakau</i>, makes for goodquality charcoal, which is essentially carbon-rich burnt down wood that is used as a form of fuel. Charcoal is no longer produced in Singapore today but the trade still thrives in parts of Southeast Asia where there are abundant tracts of <i>bakau</i>.[^35] Matang Mangrove Forest Reserve in Perak, the largest of its kind in Malaysia, for instance, produces sizable quantities of charcoal for export.
<br><br>
