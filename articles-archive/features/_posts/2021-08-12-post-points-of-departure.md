...
This painstaking process ultimately led to a photographic series called “Temporality”,<sup>7</sup> as well as a collaboration based on the same series for an iremembersg-funded project called “Points of Departure”<sup>8</sup> with Jerome Lim Who blogs on <i>The Long and Winding Road</i> (www.thelongnwindin-groad.wordpress.com). 
...
This project was supported by the Singapore Memory Project (SMP) irememberSG Fund that aims to encourage organisations and individuals to develop content and initiatives that will collect, interpret, contextualise and showcase Singapore memories. The fund has currently stopped accepting applications. For more information, go to: https://www.iremember.sg/index.php/fund-intro/ </i>
